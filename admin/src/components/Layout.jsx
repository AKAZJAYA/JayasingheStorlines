...
//   }
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      <motion.aside 
        className={`bg-white border-r border-gray-200 ${isCollapsed ? 'w-20' : 'w-64'} transition-all duration-300 ease-in-out flex flex-col`}
        initial={false}
        ...
        <div className="flex items-center h-16 px-4 border-b border-gray-200">
          {!isCollapsed ? (
            <Link to="/" className="flex items-center">
              <img src={logoImg} alt="Jayasinghe Admin" className="h-10 w-auto" />
              <div className="ml-2">
          ...
          <button 
            ...
            className={`text-gray-500 hover:text-gray-700 ${isCollapsed ? 'ml-2' : 'ml-auto'}`}
          >
