      ...
      <div className="container mx-auto px-4 py-10">
        <div className="relative mb-12">
          ...
          <div className="relative bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="mb-8 text-lg text-gray-600 max-w-3xl">
              At Jayasinghe Storelines, we offer a variety of secure payment
              options to make your shopping experience as convenient as
              possible. Choose the payment method that works best for you.
            </p>
          </div>
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              ...
              className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow transform hover:-translate-y-1 duration-300"
            >
              ...
              <p className="mb-4 text-gray-600">
                We accept all major credit and debit cards for online and
                in-store purchases.
              </p>
              <div className="flex flex-wrap gap-4 mt-6">
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="w-16 h-10 bg-gray-100 rounded-lg flex items-center justify-center shadow-sm cursor-pointer"
                >
            ...
            >
              ...
              <p className="mb-4 text-gray-600">
                Use your mobile payment apps for contactless and secure
                transactions.
              </p>
              <div className="flex flex-wrap gap-4 mt-6">
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="w-24 h-10 bg-gray-100 rounded-lg flex items-center justify-center shadow-sm cursor-pointer"
                >
            ...
            >
              ...
              <p className="mb-4 text-gray-600">
                Make a direct bank transfer to our account. Order processing
        ...
        >
          ...
          <div className="bg-white p-8 rounded-xl shadow-md">
            <ol className="relative border-l border-gray-200 ml-3">
              {[
                {
                  title: "Select your items and proceed to checkout",
                  desc: 'Add products to your cart and click the "Checkout" button when ready.',
                },
                {
                  title: "Provide shipping and contact information",
                  desc: "Enter your delivery address and contact details.",
                },
                {
                  title: "Choose your preferred payment method",
                  desc: "Select from the available payment options listed above.",
                },
                {
                  title: "Complete the payment",
                  desc: "Follow the instructions to complete your payment securely.",
                },
                {
                  title: "Receive order confirmation",
                  desc: "Once payment is processed, you'll receive an order confirmation via email.",
                },
              ].map((step, index) => (
                <motion.li
                  key={index}
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-xl shadow-md">
            <p className="mb-6 text-gray-700">
              Your security is our priority. All payment transactions are
              encrypted and processed through secure payment gateways. We use
              industry-standard security protocols to ensure your personal and
            ...
            <div className="flex flex-wrap gap-8 mt-8 justify-center">
              {[
                ...
                <motion.div
                  key={index}
                  className="bg-white p-5 rounded-xl shadow-sm flex flex-col items-center cursor-pointer"
                  whileHover={{
                    y: -5,
        ...
        >
          ...
          <p className="mb-8 max-w-2xl mx-auto">
            ...
            regarding payments or transactions.
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <motion.a
              href="tel:+94112222888"
              className="py-3 px-6 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-colors font-medium flex items-center justify-center cursor-pointer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.a
              ...
              className="py-3 px-6 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-colors font-medium flex items-center justify-center cursor-pointer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
