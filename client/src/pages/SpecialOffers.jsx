  ...
  const currentOffers = [
    {
      ...
      image:
        "https://placehold.co/600x400/4F46E5/FFFFFF/?text=Electronics+Sale",
      endDate: "May 31, 2025",
      description:
        "Huge discounts on TVs, laptops, smartphones, and more! Summer is here, and so are the hottest deals on your favorite tech.",
    ...
    },
    {
      ...
      description:
        "Refresh your home with our premium furniture collection at unbeatable prices. Limited stock available!",
    ...
    },
    {
      ...
      endDate: "May 20, 2025",
      description:
        "Purchase one item from our selected collection and get another one for free! Perfect opportunity to double your shopping joy.",
    ...
    },
    {
      ...
      description:
        "Weekend exclusive! Massive discounts across all categories for 48 hours only. Don't miss out!",
  ...
  const upcomingOffers = [
    {
      ...
      image:
        "https://placehold.co/600x400/0EA5E9/FFFFFF/?text=Anniversary+Sale",
      startDate: "June 1, 2025",
      endDate: "June 7, 2025",
      description:
        "Celebrating our 10th anniversary with incredible deals across all categories! Stay tuned for some of our biggest discounts ever.",
      categories: ["All Categories"],
    },
    {
      id: 6,
      ...
      description:
        "Every Tuesday, get exclusive deals on the latest tech products. New offers each week!",
  ...
  const exclusiveOffers = [
    {
      ...
      description:
        "Exclusive deal for our loyalty program members. Sign in to your account to unlock this special discount on any purchase.",
    ...
    },
    {
      ...
      description:
        "New to Jayasinghe Storelines? Enjoy 15% off your first purchase when you create an account.",
      ...
      <div className="container mx-auto px-4 py-10">
          ...
          <div className="relative z-10 py-16 px-8 text-white">
            ...
            >
              ...
              <p className="text-xl max-w-3xl mb-8 text-pink-100">
                Discover incredible deals and limited-time offers on our wide
                range of products. Don't miss out on these amazing savings!
              </p>
            ...
            <div className="md:flex">
              ...
              <div className="p-8 md:w-3/5">
                ...
                <p className="mb-6 text-lg text-gray-600">
                  Up to 70% off on select items across all categories. Hurry
        ...
        <div id="current-offers" className="mb-16">
          <div className="mb-8 flex border-b border-gray-200">
            <motion.button
              className={`py-3 px-5 font-medium text-lg relative ${
                activeTab === "current"
                  ? "text-purple-600"
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {offer.categories.map((category, i) => (
                            <span
                              key={i}
                              className="bg-purple-50 text-purple-600 px-2 py-1 rounded text-xs"
                            >
                              {category}
                            </span>
                          ))}
              ...
              >
                ...
                >
                  ...
                  <p className="mb-6 max-w-2xl mx-auto">
                    Sign up for our loyalty program to unlock exclusive
                    member-only offers, earn points on every purchase, and enjoy
                    special benefits.
                  </p>
                  <motion.button
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="mb-2">
                ...
                any time without notice. Discounts cannot be used in conjunction
                with other promotional offers unless explicitly stated. Some
